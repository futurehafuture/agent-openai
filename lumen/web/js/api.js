...
export const api = {
  ...
  chooseWorkspace: () => sendJSON("/api/workspace/choose", "POST"),
  listWorkspaceFiles: () => getJSON("/api/workspace/files"),
  previewWorkspaceFile: (path) => getJSON(`/api/workspace/preview?path=${encodeURIComponent(path)}`),
